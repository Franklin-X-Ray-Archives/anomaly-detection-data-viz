...
def about_popover(is_clicked: bool, is_open: bool, active: bool) -> tuple[bool, bool]:
...
def upload_event(filename: str) -> list[str]:
...
def results(n_clicks: int, contents: str, filename: str) -> tuple[str, go.Figure]:
