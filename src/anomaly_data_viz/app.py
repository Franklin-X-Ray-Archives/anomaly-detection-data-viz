...
class App:
        ...
        children=[
            ...
            dbc.NavItem(
                html.Div(
                    [
                        dbc.NavLink(
                            "About", href="/", id="about-popover", active=False
                        ),
                        dbc.Popover(
                            id="about",
                            is_open=False,
    ...
    def about_popover(
        self, is_clicked: bool, is_open: bool, active: bool
    ) -> tuple[bool, bool]:
    ...
    def upload_event(self, filename: str) -> list[str]:
    ...
    def results(
        self, n_clicks: int, contents: str, filename: str
    ) -> tuple[str, go.Figure]:
